...
const typeDefs = gql`
  ...
  type Mutation {
    ...
    addMSPSS(mspss1: String, mspss2: String, mspss3: String, mspss4: String, mspss5: String, mspss6: String, mspss7: String, mspss8: String, mspss9: String, mspss10: String, mspss11: String, mspss12: String, mspssSum: String): MSPSS
